...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    j0.b1.whenPressed( new InstantCommand( () -> pistons.toggle() ) ); 
    j0.b1.whileHeld(new InstantCommand( () -> intake.move( RobotMap.INTAKE_SPEED ) ) ); 
    j0.b1.whenReleased( new InstantCommand( () -> pistons.toggle() ) ); 

    c0.lBumper.whileHeld( new InstantCommand( () -> lowerIndexer.move( RobotMap.LOWER_INDEXER_ID ) ) ); 
